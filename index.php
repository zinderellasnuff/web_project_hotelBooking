      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
            ...
            <p><a href="#" class="btn btn-primary">Learn more</a> <a href="<?php echo APPURL;?>/conctact.php" class="btn btn-white">Contact us</a></p>
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="half left-arrow d-flex align-items-center">
                  <div class="text p-4 p-xl-5 text-center">
                    ...
                    <ul class="list-accomodation">
                      <li><span>Max:</span> <?php echo $room->num_persons; ?> 3 Persons</li>
                      <li><span>Size:</span> <?php echo $room->size; ?> 45 m2</li>
                      <li><span>View:</span> <?php echo $room->view; ?> Sea View</li>
                      <li><span>Bed:</span> <?php echo $room->num_beds; ?> 1</li>
                    </ul>
