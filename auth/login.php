...
if(isset($_POST['submit'])){
  if(empty($_POST['email']) OR empty($_POST['password'])){  // Cambiado 'mpty' a 'empty'
    ...
    // validar el correo electrónico con la consulta
    ...
    if($login->rowCount() > 0) {
      ...
      if(password_verify($password, $fetch['mypassword'])){
        // echo "<script>alert('INICIADO SESIÓN')</script>";
